...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gaeaengine.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gaeaengine.exe: ${OBJECTFILES}
...
${OBJECTDIR}/Vector_2D.o: Vector_2D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Vector_2D.o Vector_2D.cpp
